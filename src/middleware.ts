...
export function middleware(request: NextRequest) {
    ...
    const systemPaths = ['api', '_next', 'setup', 'platform-setup', 'super-admin', 'favicon.ico', 'logo.png', 'globals.css', 's'];
    const reservedRoutes = ['login', 'dashboard', 'teachers', 'students', 'classes', 'subjects', 'exams', 'attendance', 'fees', 'accounts', 'settings', 'reports', 'super-admin', 'setup', 'platform-setup'];
